...
[`cipher seed`](https://github.com/BTCGPU/lnd/tree/master/aezeed).
...
[`dropwtxmgr`](https://github.com/btgsuite/btgwallet/tree/master/cmd/dropwtxmgr).
It can be installed with the following command:
```
⛰  go get -v -u github.com/btgsuite/btgwallet/cmd/dropwtxmgr
```
...
Once the process has been initiated, `lnd` will proceed to:
  ...
  2. Once the channel shell is recovered, the
     [chanbackup](https://github.com/BTCGPU/lnd/tree/master/chanbackup)
