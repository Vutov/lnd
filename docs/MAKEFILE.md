...
`btcd`
------
Ensures that the [`github.com/btgsuite/btgd`][btcd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/btgsuite/btgd`][btcd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/btgsuite/btgd`][btcd] specified
...
`itest`
-------
Installs the version of [`github.com/btgsuite/btgd`][btcd] specified in
...
[btcd]: https://github.com/btgsuite/btgd (github.com/btgsuite/btgd")
