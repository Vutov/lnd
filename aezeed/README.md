...
[In this PR](https://github.com/BTCGPU/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/BTCGPU/lnd/aezeed
...
PASS
ok      github.com/BTCGPU/lnd/aezeed  4.168s
```
