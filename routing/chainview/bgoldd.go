...
// interface which is backed by bgoldd.
type BgolddFilteredChainView struct {
	started int32
	stopped int32
...
// A compile time check to ensure BgolddFilteredChainView implements the
// chainview.FilteredChainView.
var _ FilteredChainView = (*BgolddFilteredChainView)(nil)
...
func (b *BgolddFilteredChainView) Start() error {
	// Already started?
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *BgolddFilteredChainView) Stop() error {
...
func (b *BgolddFilteredChainView) onFilteredBlockConnected(height int32,
...
func (b *BgolddFilteredChainView) onFilteredBlockDisconnected(height int32,
	hash chainhash.Hash) {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *BgolddFilteredChainView) FilterBlock(blockHash *chainhash.Hash) (*FilteredBlock, error) {
	req := &filterBlockReq{
		blockHash: blockHash,
...
func (b *BgolddFilteredChainView) chainFilterer() {
	defer b.wg.Done()
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *BgolddFilteredChainView) UpdateFilter(ops []wire.OutPoint, updateHeight uint32) error {
	select {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *BgolddFilteredChainView) FilteredBlocks() <-chan *FilteredBlock {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *BgolddFilteredChainView) DisconnectedBlocks() <-chan *FilteredBlock {
