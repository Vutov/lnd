...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/BTCGPU/lnd/lnrpc)
...
```bash
$ go get -u github.com/BTCGPU/lnd/lnrpc
```
...
5. Run [`gen_protos.sh`](https://github.com/BTCGPU/lnd/blob/master/lnrpc/gen_protos.sh) to generate new protobuf definitions.
